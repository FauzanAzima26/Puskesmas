              ...
              <div class="row gy-4">
                ...
                <div class="col-12 col-lg">
                  ...
                  <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                      <a class="nav-link mega-dropdown-link" href="../vertical-menu-template/pages-misc-comingsoon.html"
                        target="_blank">
                        <i class="ti ti-circle me-1"></i>
                        Coming Soon
                      </a>
                    ...
                    <li class="nav-item">
                      <a class="nav-link mega-dropdown-link" href="../vertical-menu-template/auth-two-steps-basic.html"
                        target="_blank">
                        <i class="ti ti-circle me-1"></i>
                        Two Steps (Basic)
                      </a>
                    ...
                    <li class="nav-item">
                      <a class="nav-link mega-dropdown-link" href="../vertical-menu-template/auth-two-steps-cover.html"
                        target="_blank">
                        <i class="ti ti-circle me-1"></i>
                        Two Steps (Cover)
                      </a>
...
<div data-bs-spy="scroll" class="scrollspy-example">
  ...
  <section id="hero-animation">
    <div id="landingHero" class="section-py landing-hero position-relative">
      <img src="<?= base_url('assets/img/front-pages/backgrounds/hero-bg.png') ?>" alt="hero background"
